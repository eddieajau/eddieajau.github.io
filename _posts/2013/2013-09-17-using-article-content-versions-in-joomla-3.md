...
* Enabled or disable article content versioning (find it under the Articles component options).</li>
* Set the maximum number of versions to keep.</li>
* Compare two versions and see the differences with or with the HTML code.</li>
* Keep any of the versions forever.</li>
* Delete any of the versions.</li>
